...
.PHONY: build
build: node_modules build/EpicNullPlat.jar build/EpicCommon.jar build/EpicDesktop.jar
...
build/EpicNullPlat.jar: $(java_src_files_null)
...
build/EpicCommon.jar: $(java_src_files_common) build/EpicNullPlat.jar
	@mkdir -p build/classes_common
...
build/EpicDesktop.jar: $(java_src_files_desktop) build/EpicNullPlat.jar
	...
	jar cf build/EpicDesktop.jar -C build/classes_desktop com/epic/framework/implementation $(JAROPT_COMMON)
	jar cf build/EpicDesktop.src.jar -C EpicDesktop/src com/epic/framework/implementation $(JAROPT_COMMON_SRC)
