...
import com.epic.framework.Ui.EpicAnimationSequence.EpicAnimationFrame;
...
import com.epic.framework.util.EpicSocialImplementation;
import com.epic.framework.util.EpicSoundManager;
...
public class EpicPlatform {
	...
	static boolean onPlatformKeyPress(int c) {
	...
	static boolean onPlatformBackKey() {
		synchronized (singleThreadingLock) {
