...
import com.epic.framework.util.exceptions.EpicAssertionFailedException;
import com.epic.framework.util.exceptions.EpicFrameworkException;
import com.epic.framework.util.exceptions.EpicInvalidArgumentException;
import com.epic.framework.util.exceptions.EpicMissingImageException;
import com.epic.framework.util.exceptions.EpicNoSuchElementException;
import com.epic.framework.util.exceptions.EpicNotImplementedException;
import com.epic.framework.util.exceptions.EpicNotSupportedException;
import com.epic.framework.util.exceptions.EpicNullPointerException;
import com.epic.framework.util.exceptions.EpicStringFormatException;
import com.epic.framework.util.exceptions.EpicUnexpectedDataException;
import com.epic.framework.util.exceptions.EpicUnhandledCaseException;
...
public class EpicFail {
	...
	public static EpicRuntimeException generic(String msg) {
		return log_exception( new EpicRuntimeException(msg));
	}
