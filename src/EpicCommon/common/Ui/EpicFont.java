...
public class EpicFont {
	...
	public static final EpicFont FONT_MAIN = EpicPlatform.isBlackberry() ? EpicFont.fromName("BBAlpha Sans", 12) : EpicProjectConfig.mainFont;
	public static final EpicFont FONT_GAME = EpicProjectConfig.gameFont;
