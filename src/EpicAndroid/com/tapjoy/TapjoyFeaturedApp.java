...
public class TapjoyFeaturedApp
{
	...
	private int displayCount = EpicProjectConfig.isReleaseMode ? 10 : 9999;											// By default, each featured app is only displayed five times before it no longer being displayed.
