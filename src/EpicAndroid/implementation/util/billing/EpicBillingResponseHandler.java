...
import com.epic.framework.implementation.util.billing.EpicBillingConstants.PurchaseState;
import com.epic.framework.implementation.util.billing.EpicBillingConstants.ResponseCode;
import com.epic.framework.implementation.util.billing.EpicInAppService.RequestPurchase;
import com.epic.framework.implementation.util.billing.EpicInAppService.RestoreTransactions;
 ...
 */
public class EpicBillingResponseHandler {
    private static final String TAG = "ResponseHandler";

    /**
     * This is a static instance of {@link EpicBillingPurchaseObserver} that the
     * application creates and registers with this class. The PurchaseObserver
     * is used for updating the UI if the UI is visible.
     */
    private static EpicBillingPurchaseObserver sPurchaseObserver;

    /**
     * Registers an observer that updates the UI.
     * @param observer the observer to register
     */
    public static synchronized void register(EpicBillingPurchaseObserver observer) {
     ...
     */
    public static synchronized void unregister(EpicBillingPurchaseObserver observer) {
    ...
    public static void purchaseResponse(
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                synchronized(EpicBillingResponseHandler.class) {
                    if (sPurchaseObserver != null) {
                    	// TODO: FIXED QUANTITY TO 1, THIS IS PROBABLY VERY WRONG
     ...
     * purchase state changes are received in the {@link EpicBillingReceiver} and
