 ...
 * {@link EpicBillingResponseHandler}. The main application implements the callbacks
 ...
 */
public abstract class EpicBillingPurchaseObserver {
    ...
    public EpicBillingPurchaseObserver(Activity activity, Handler handler) {
        mActivity = activity;
        mHandler = handler;
     ...
     * {@link EpicBillingResponseHandler#purchaseResponse(Context, PurchaseState,
     * String, String, long)}.
