 ...
 */
public class EpicBillingSecurityHelpers {
     ...
     * This has to be "static" so that the {@link EpicBillingReceiver} can
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "";
            PublicKey key = EpicBillingSecurityHelpers.generatePublicKey(base64EncodedPublicKey);
            verified = EpicBillingSecurityHelpers.verify(key, signedData, signature);
            if (!verified) {
        ...
        if (!EpicBillingSecurityHelpers.isNonceKnown(nonce)) {
