...
- (int) size__;
{
  return [self->internalArray size__];
}

- (int) contains___java_lang_Object :(java_lang_Object*) item;
{
  return [self->internalArray contains___java_lang_Object: item];
}

- (BOOL) isEmpty__;
{
  return [self->internalArray isEmpty__];
}

- (java_util_Iterator*) iterator__;
{
  return [self->internalArray iterator__];
}

- (int) indexOf___java_lang_Object :(java_lang_Object*) item;
{
  return [self->internalArray indexOf___java_lang_Object: item];
}

- (java_lang_Object*) get___int :(int) idx;
{
  return [self->internalArray get___int: idx];
}

- (void) __init_java_util_ArrayList__
{
    [self->internalArray __init_java_util_ArrayList__];
}

- (void) __init_java_util_ArrayList___int:(int)initialCapacity;
{
    [self->internalArray __init_java_util_ArrayList___int: initialCapacity];
}

- (void) __init_java_util_ArrayList___java_util_Collection:(java_util_Collection*)c;
{
    [self->internalArray __init_java_util_ArrayList___java_util_Collection: c];
}

- (BOOL) add___java_lang_Object :(java_lang_Object*) item;
{
    return [self->internalArray add___java_lang_Object: item];
}

- (void) add___int_java_lang_Object :(int) idx :(java_lang_Object*) item;
{
    [self->internalArray add___int_java_lang_Object: idx: item];
}

- (BOOL) addAll___java_util_Collection:(java_util_Collection*)c;
{
    return [self->internalArray addAll___java_util_Collection: c];
}

- (java_lang_Object*) set___int_java_lang_Object :(int) idx: (java_lang_Object*) item;
{
    return [self->internalArray set___int_java_lang_Object: item];
}

- (java_lang_Object*) remove___int :(int) idx;
{
    return [self->internalArray remove___int: idx];
}

- (BOOL) remove___java_lang_Object :(java_lang_Object*) item;
{
    return [self->internalArray remove___java_lang_Object: item];
}

- (BOOL) removeAll___java_util_Collection:(java_util_Collection*) c;
{
    return [self->internalArray removeAll___java_util_Collection: c];
}
...
- (void) clear__;
{
    [self->internalArray clear__];
}

- (XMLVMArray*) toArray__;
{
    return [self->internalArray toArray__];
}

- (XMLVMArray*) toArray___java_lang_Object_ARRAYTYPE:(XMLVMArray*) contents;
{
    return [self->internalArray toArray___java_lang_Object_ARRAYTYPE: contents];
}
