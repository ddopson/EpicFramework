...
package com.epic.framework.implementation.tapjoy;
...
public class TapjoyVideo
{
	...
	private static final String imageBackgroundUrl									= "https://s3.amazonaws.com/tapjoy/videos/assets/background.png";
	private static final String imagePlaceholderUrl									= "https://s3.amazonaws.com/tapjoy/videos/assets/placeholder.png";
	private static final String imageTapjoyUrl										= "https://s3.amazonaws.com/tapjoy/videos/assets/tapjoy.png";
...
//		cacheDir = Environment.getExternalStorageDirectory().toString() + "/tapjoy/cache/" + TapjoyConnectCore.getClientPackage() + "/";
		videoCacheDir = Environment.getExternalStorageDirectory().toString() + "/tapjoy/cache/videos/";
		imageCacheDir = Environment.getExternalStorageDirectory().toString() + "/tapjoy/cache/images/";
		...
		uncachedImages.put("background", imageBackgroundUrl);
		uncachedImages.put("placeholder", imagePlaceholderUrl);
		uncachedImages.put("tapjoy", imageTapjoyUrl);
		
		imageBackgroundLocation = imageCacheDir + "background.png";
		imagePlaceholderLocation = imageCacheDir + "placeholder.png";
		imageTapjoyLocation = imageCacheDir + "tapjoy.png";
	...
	public boolean startVideo(String videoID, String currencyName, String currencyAmount, String clickURL)
	{
		...
		Intent videoIntent = new Intent(context, com.epic.framework.implementation.tapjoy.TapjoyVideoView.class);
